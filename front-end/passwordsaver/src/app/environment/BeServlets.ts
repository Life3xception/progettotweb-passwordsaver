...
export const BeApis = {
    ...
    getdetaileddeletedpasswordsbyuser: `${BeMainApis.passwords}/getdetaileddeletedpasswordsbyuser`,
    ...
    recoverpassword: `${BeMainApis.passwords}/recoverpassword`,
    deletepassword: `${BeMainApis.passwords}/deletepassword`,
    getuser: `${BeMainApis.users}/getuser`,
    getdetailedusers: `${BeMainApis.users}/getdetailedusers`,
    getdetaileduser: `${BeMainApis.users}/getdetaileduser`,
    ...
    getdetailedservice: `${BeMainApis.services}/getdetailedservice`,
    getdetailedservices: `${BeMainApis.services}/getdetailedservices`,
    getdetailedservicesbyservicetype: `${BeMainApis.services}/getdetailedservicesbyservicetype`,
